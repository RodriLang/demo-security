...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ErrorResponseDto> handleGameNotFoundException(EntityNotFoundException e, HttpServletRequest request) {
        ErrorResponseDto response = buildResponse(HttpStatus.NOT_FOUND, e.getMessage(), request.getServletPath());
    ...
    private ResponseEntity<ErrorResponseDto> handleInactiveGameException(InactiveGameException e, HttpServletRequest request) {
        ErrorResponseDto response = buildResponse(HttpStatus.CONFLICT, e.getMessage(), request.getServletPath());
    ...
    public ResponseEntity<ErrorResponseDto> handleBadCredentials(BadCredentialsException e, HttpServletRequest request) {
        ErrorResponseDto response = buildResponse(HttpStatus.UNAUTHORIZED, e.getMessage(), request.getServletPath());
    ...
    public ResponseEntity<ErrorResponseDto> handleInvalidToken(InvalidTokenException e, HttpServletRequest request) {
        ErrorResponseDto response = buildResponse(HttpStatus.UNAUTHORIZED, e.getMessage(), request.getServletPath());
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(response);
    }
    ...
    public ResponseEntity<ErrorResponseDto> handleException(Exception e, HttpServletRequest request) {
        ErrorResponseDto response = buildResponse(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage(), request.getServletPath());
